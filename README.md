...
for the server extension and a NPM package named `ploomber-extension`
...
```bash
pip install ploomber_extension
```
...
```bash
pip uninstall ploomber_extension
```
...
# Change directory to the ploomber_extension directory
...
jupyter server extension disable ploomber_extension
pip uninstall ploomber_extension
```
...
```sh
pytest -vv -r ap --cov ploomber_extension
```
